...
final class PasswordManagerService: ObservableObject {
    ...
    private let serviceName = "io.github.imsumitkumar.slate.passwords"
...
enum PasswordManagerError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalidStoredPassword:
            return "Slate couldn't decode the stored password."
        case .invalidCredentialOrigin:
            return "Slate can only save passwords for web origins."
